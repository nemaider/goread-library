...
<div class="body-content">
        ...
        echo '<p class="text">Books that you have bought in our library: </p>';
        ...
        if($result = mysqli_query($conn, $query)){
                   ...
                   while($row2 = $result2->fetch_assoc()) {
                        ...
                        $row = $result->fetch_assoc();
                            if($row2['id_book'] == $row['id_book']) {
                                ...
                                <td class="db-subinfo">'.$row['category'].'</td><td class="db-subinfo">'.$row['price'].'</td><td class="db-subinfo">'.$row2['day'].'</td></tr>';
         ...
         echo '<br><br><p class="text">Books that you have borrowed in our library: </p>';
                   ...
                   while($row2 = $result2->fetch_assoc()) {
                        ...
                        $row = $result->fetch_assoc();
                            if($row2['id_book'] == $row['id_book']) {
                                ...
                                <td class="db-subinfo">'.$row['category'].'</td><td class="db-subinfo">'.$row['price']*0.2.'</td><td class="db-subinfo">'.$row2['day'].'</td></tr>';
