...
<div class="body-content">
        ...
        if($result = mysqli_query($conn, $query)){
            ...
            if(isset($_SESSION['borrow_info'])){
                echo $_SESSION['borrow_info'];
                unset($_SESSION['borrow_info']);
            }
        }

        echo '<p class="text">Books that you can borrow in our library: </p>';
               ...
               echo '</tr><br>';
                ...
                if($_SESSION['permission']=="reader"){
                   ...
                   while($row = $result->fetch_assoc()) {
                    ...
                    <td class="db-subinfo">'.$row['category'].'</td><td class="db-subinfo">'.$row['price']*0.2.'</td><td class="db-subinfo">'.$row['amount'].'</td><td>'
